...
<template>
    <!-- navbar -->
    <nav class="fixed top-0 z-50 w-full bg-gray-800 border-b border-gray-900 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex items-center ms-3">
                        <div class="relative">
                            <button type="button" @click="toggleIconUser"
                                ...
                                <span class="hidden lg:block mx-2">เจษฎากร หวานสนิท
                            ...
                            <div v-if="iconUserOpen" ref="iconUserMenu"
                                ...
                                <div class="lg:hidden px-4 py-3 w-full" role="none">
                                    <p class="text-md font-semibold text-gray-900 dark:text-white whitespace-nowrap"
                                        role="none">
                                        เจษฎากร หวานสนิท
                                    </p>
                                ...
                                <ul class="py-1" role="none">
                                    <li>
                                        <a href="#" @click="closeiconUserMenu"
    ...
    <!-- sidebar -->
    <aside v-if="sidebarOpen" ref="sidebarMenu"
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 bg-gray-800 border-r border-gray-800" aria-label="Sidebar">
                ...
                <li @click="showFormTable">
                    <RouterLink to="/backend/manage-order">
                        <a href="#" class="flex items-center p-2 text-white rounded-lg group">
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">รายการคำสั่งซื้อ</span>
                        </a>
                    </RouterLink>
                </li>
                <li>
