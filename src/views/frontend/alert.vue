                ...
                <div class="mt-2 mb-2">
                    <div class="p-4 w-full rounded-md text-gray-600">
                        ...
                        <RouterLink to="/order-detail">
                            <div class="p-4 mb-4 text-md text-gray-600 rounded-lg bg-gray-50 cursor-pointer relative shadow-md"
                                role="alert">
                                <span class="font-semibold block lg:inline">เลขที่ <span
                                        class="text-orange-500">78945623</span> อยู่ในสถานะ 'จัดเตรียมสินค้า'</span>
                                <span class="block lg:inline">
                                    วันที่ 2024/12/06 เวลา 09:31
                                </span>

                                <span class="hidden lg:block absolute right-3 top-1/2 transform -translate-y-1/2">
